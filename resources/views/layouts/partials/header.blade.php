...
<div class="container mx-auto flex items-center justify-between px-2 sm:px-0">
    ...
    <figure>
        <a href="#" class="flex items-center">
            <span class="span text-xl">F</span>
    ...
    <div class="flex items-center gap-3">
        ...
        {{-- <a href="" class="px-4 py-2 hover:bg-primary hover:text-white rounded-pill transition duration-200 ease-in-out">Sign In</a>
        ...
        <div class="flex items-center gap-6">
            ...
            <div class="relative">
                <button type="button" class="flex items-center gap-3 px-4 py-2 bg-primary text-white hover:text-opacity-90 rounded-primary">
                    <figure>
                        <img src="" class="w-6 h-6 bg-gray-third rounded-full" alt="">
                    </figure>
                    <span class="font-inter">Adnan Erlansyah</span>
                </button>
                <ul class="hidden absolute top-[140%] rounded-primary bg-primary text-white w-full shadow-[0px_0px_8px_2px_rgba(0,0,0,0.25)]">
