...
<div class="container mx-auto flex items-center justify-between px-2 sm:px-0">
    ...
    <div class="flex items-center gap-3 sm:gap-2">
        ...
        <a href="" class="text-xs sm:text-base px-4 py-2 hover:bg-primary hover:text-white rounded-pill transition duration-200 ease-in-out">Sign In</a>
        <a href="" class="text-xs sm:text-base px-4 py-2 hover:bg-primary hover:text-white rounded-pill transition duration-200 ease-in-out">Sign Up</a>
