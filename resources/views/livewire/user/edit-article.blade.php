    ...
    " style="display: none;" x-ref="wrapperEditArticle">
        ...
        <div x-data="helpers" class="container mx-auto flex items-center dark:text-white">
            ...
            <form class="col lg:mx-0 col-12">
                <p class="flex items-center gap-2 mb-4" x-show="!isLoading">
                    <b>Created At : </b>
                    <span x-text="convertDate(EditArticle?.created_at)"
                        class="px-2 py-1 rounded-lg bg-primary text-white dark:bg-slate-third" style="display: none;"
                        x-init="
                        setTimeout(function() {
                ...
                <div class="flex flex-wrap lg:flex-nowrap">
                    <div class="mb-5 col-12 lg:col-6">
                        ...
                        <input x-model="EditArticle.title" onchange="isDirty()" type="text" placeholder="Your text..."
                            name="title" id="title"
                    ...
                    <div class="mb-5 col-12 lg:col lg:col-6">
                        ...
                        <select multiple onchange="isDirty()" name="category_id[]" id="category_id"
                            ...
                            <template x-for="(c, index) in categories">
                                <option :value="c.id"
                                    :selected="EditArticle?.tags?.some(element => element.category_id == c.id)"
                                    x-text="c.name">test</option>
                            </template>
                        </select>
                        ...
                        <template x-if="status_err?.[0]?.category_id">
                            <div class="mt-3 flex text-[#b91c1c] items-center gap-2">
                                ...
                                <span class="span-danger" x-text="status_err?.[0]?.category_id[0]">Validation
                                    Error</span>
                            </div>
                        </template>
                ...
                <div class="mb-5">
                    ...
                    <input x-on:change="EditArticle.thumbnail = Object.values($event.target.files)" onchange="isDirty()"
                        type="file" accept="image/*" name="thumbnail" id="thumbnail" placeholder="Your thumbnail..."
                        hidden x-ref="file" @change="
                            if ($refs.file) {
                    ...
                    <span
                        ...
                        ">
                        <img x-ref="image"
                            x-bind:src="!EditArticle?.thumbnail_1 ? imgUrl + EditArticle?.thumbnail : EditArticle?.thumbnail_1"
                            class="absolute w-full h-full rounded-lg object-fill"
                            x-bind:alt="EditArticle?.thumbnail_1_alt" onerror="this.style.opacity = 0"
                            onload="this.style.opacity = 1">
                        <div class="text-center" x-ref="iconimage">
                            <i data-feather="image"
                                class="w-[100px] h-[100px] lg:h-[100px] mx-auto text-primary dark:text-white">
                            </i>
                            <span class="block mt-4">
                                <b class="span dark:text-white">Click to Upload</b> <br>
                                <p class="text-sm font-semibold">(SVG, PNG, JPG, JPEG)</p>
                            </span>
                        </div>
                        <div class="text-center" x-ref="iconimageerror" style="display: none;">
                            <i data-feather="alert-circle"
                                class="w-[100px] h-[100px] lg:h-[100px] mx-auto text-primary dark:text-white">
                            </i>
                            <span class="block mt-4">
                                <b class="span dark:text-white">Oops!</b> You cannot input anything other than images.
                                <br>
                                <b>Please Click Again</b>
                            </span>
                        </div>
                        <p x-show="EditArticle?.thumbnail_1_alt" x-text="EditArticle?.thumbnail_1_alt" x-ref="filename"
                            class="filename absolute w-full -bottom-1/2 py-2 bg-primary text-white text-center font-semibold rounded-lg transition duration-200 ease-in-out active">
                        </p>
                    </span>
                ...
                <div class="mb-5 col-12">
                    ...
                    <textarea x-text="EditArticle?.description" name="description" id="content"
        ...
        <div class="relative container mx-auto mt-4" x-data="{
            ...
            <div class="w-full my-1 px-5 lg:px-0 dark:text-white">
                ...
                <p
                    class="font-semibold text-sm lg:text-base mb-2 bg-primary dark:bg-white dark:text-slate-secondary bg-opacity-20 p-3 rounded-lg">
                    *If you make three paid sub contents, then you must have to create 3 free content first.
                </p>

                <ul class="flex flex-col mb-10">

                    <li class="bg-white dark:bg-slate-secondary dark:text-white my-2 shadow-[0px_0px_4px_rgba(0,0,0,0.25)] rounded-lg"
                        x-data="accordion(1)">
                        <h2 @click="handleClick()"
                            ...
                            <div class="flex items-center gap-2">
                                <span :class="handleRotate()"
                                    class="h-6 w-6 transform transiton-transform duration-200 ease-in-out" title="Open">
                                    <ion-icon name="chevron-down-circle-outline"
                                        class="w-full h-full text-primary dark:text-white dark:hover:text-opacity:75">
                                    </ion-icon>
                                </span>
                            </div>
                        </h2>
                            ...
                            <div class="px-1 h-[500px]">
                                <div class="flex flex-wrap gap-4 max-h-[500px] pb-4 overflow-y-auto">
                                    <template x-for="(s, index) in EditArticle?.subarticles">
                                        <span type="button" x-show="s" x-bind:class="[
                                            ...
                                            <div class="flex items-center gap-1">
                                                <b x-text="Number(index + 1) + '. '"
                                                    class="text-primary dark:text-white group-hover:text-white"></b>
                                                <b x-text="s?.title ? s?.title : 'New Sub-Article'">Sub-EditArticle
                                                    1</b>
                                            </div>
                                            <div class="flex items-center gap-1">
                                    ...
                                    " type="button"
                                        ...
                                        <i data-feather="plus-circle"
                                            class="w-6 h-6 text-primary group-hover:text-white dark:text-slate-fourth group-hover:rotate-90 transition duration-200 ease-in-out"></i>
                ...
                <div x-show="EditArticle?.subarticles?.length">
                    <div class="flex flex-wrap lg:flex-nowrap" x-data="helpers">
                        <div class="mb-5 col-12">
                            <div class="flex justify-between">
                                ...
                                <template x-if="EditArticle?.subarticles?.[editSub]?.created_at">
                                    <p class="flex items-center gap-2 mb-4">
                                        <b>Created At : </b>
                                        <span x-show="EditArticle?.subarticles?.[editSub]?.created_at"
                                            x-text="convertDate(EditArticle?.subarticles?.[editSub]?.created_at)"
                                            class="px-2 py-1 rounded-lg bg-primary text-white dark:bg-slate-third"
                            ...
                            <input x-bind:value="EditArticle?.subarticles?.[editSub]?.title" x-on:change="
                    ...
                    <div class="mb-5">
                        ...
                        <input x-on:change="
                            ...
                            changed_sub.set(editSub, true);
                            localStorage.setItem('changed_sub', changed_sub.size);
                        " type="file" accept="image/*" name="thumbnail_subarticle" placeholder="Your thumbnail..."
                            hidden name="sub_thumbnail" id="sub_thumbnail" x-ref="filesubarticle" @change="
                        ...
                        <span
                            ...
                            ">
                            <img x-ref="imagesubarticle"
                                x-bind:src="!EditArticle?.subarticles?.[editSub]?.thumbnail_1 ? imgUrl + EditArticle?.subarticles?.[editSub]?.thumbnail : EditArticle?.subarticles?.[editSub]?.thumbnail_1"
                                class="absolute w-full h-full rounded-lg  object-fill"
                                x-bind:alt="EditArticle?.subarticles?.[editSub]?.thumbnail_1_alt"
                                onerror="this.style.opacity = 0" onload="this.style.opacity = 1" accept="image/*">
                            <div class="text-center" x-ref="iconimagesubarticle">
                                <i data-feather="image"
                                    class="w-[100px] h-[100px] lg:h-[100px] mx-auto text-primary dark:text-white">
                                </i>
                                <span class="block mt-4">
                            ...
                            <div class="text-center" x-ref="iconimagesubarticleerror" style="display: none;">
                                <i data-feather="alert-circle"
                                    class="w-[100px] h-[100px] lg:h-[100px] mx-auto text-primary dark:text-white">
                                </i>
                                <span class="block mt-4">
                                    <b class="span dark:text-white">Oops!</b> You cannot input anything other than
                                    images. <br>
                                    <b>Please Click Again</b>
                                </span>
                            </div>
                            <p x-show="EditArticle?.subarticles?.[editSub]?.thumbnail_1_alt"
                                x-text="EditArticle?.subarticles?.[editSub]?.thumbnail_1_alt" x-ref="filenamesubarticle"
                                class="filenamesubarticle absolute w-full -bottom-1/2 py-2 bg-primary text-white text-center font-semibold rounded-lg transition duration-200 ease-in-out active">
                            </p>
                        </span>
                    ...
                    <div class="mb-5 col-12">
                        ...
                        <textarea x-text="EditArticle?.subarticles?.[editSub]?.description" name="sub_description"
                            id="sub_content" placeholder="Your content..."
                            class="px-3 py-4 w-full shadow-[0px_0px_4px_rgba(0,0,0,0.25)] rounded-primary bg-white">
                        </textarea>
                        <template
                            x-if="setTiny?.('sub_content', EditArticle?.subarticles?.[editSub]?.description);"></template>
                        ...
                        <template x-if="status_err?.[1]?.description">
                            <div class="mt-3 flex text-[#b91c1c] items-center gap-2">
                                ...
                                <span class="span-danger" x-text="status_err?.[1]?.description[0]">Validation
                                    Error</span>
                            </div>
                        </template>
                    </div>
                        ...
                        <div class="flex items-center gap-2 mt-2">
                            <label for="free" class="flex items-center gap-1">
                                <input type="radio" name="status" id="free" value="free"
                                    class="bg-gray-third checked:accent-primary dark:checked:accent-slate-third"
                                    x-bind:checked="EditArticle?.subarticles?.[editSub]?.type == 'free'" x-on:change="
                            ...
                            <label for="paid" class="flex items-center gap-1">
                                <input type="radio" name="status" id="paid" value="paid"
                                    class="bg-gray-third checked:accent-primary dark:checked:accent-slate-third"
                                    x-bind:checked="EditArticle?.subarticles?.[editSub]?.type == 'paid'" x-on:change="
                                    console.log(EditArticle.subarticles);
                                    EditArticle.subarticles[editSub].type = $event.target.value
                                    changed_sub.set(editSub, true);
                                    localStorage.setItem('changed_sub', changed_sub.size);
        ...
        <x-modal-instruction>
            <ul>
                <li class="mb-4">
                    <b
                        class="text-primary dark:text-white border border-primary dark:border-white py-1 px-2">Validation</b>
                </li>
            ...
            <ul class="mt-4">
                <li class="mb-4">
                    <b class="text-primary dark:text-white border border-primary dark:border-white py-1 px-2">Write a
                        Content</b>
                </li>
                <li class="flex items-start gap-2">
                    <b class="text-primary dark:text-white">1.</b>
