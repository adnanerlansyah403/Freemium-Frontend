                    ...
                    <div x-data="helpers">
                        <div class="flex items-center lg:gap-6 mb-10">
                            <div class="h-[44px] col col-10 lg:mx-0 w-full py-2.5 px-3 rounded-[10px] border-solid border border-primary dark:border-white">
                                <div class="flex justify-between">
                                    <input
                                        ...
                                        x-on:change="searchMyArticle(keywordMyArticle)"
                            ...
                            <div class="col" style="margin-left: 0;">
                                <button @click="keywordMyArticle = ''; fetchListMyArticle()" class="px-6 py-2 border border-primary dark:border-white hover:bg-primary dark:hover:bg-white hover:text-white dark:hover:text-slate-secondary rounded-pill transition duration-200 ease-in-out">
                                    Reset
                                </button>
                            </div>
                        </div>
