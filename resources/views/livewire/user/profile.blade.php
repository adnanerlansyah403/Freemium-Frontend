...
<section class="py-[100px]" x-data="user">
    ...
    <div class="container mx-auto flex flex-wrap md:flex-nowrap gap-10 lg:gap-0" x-data="user">
        ...
        <div class="col col-12 order-2 md:ml-0 lg:order-1 lg:col-8">
            ...
            <div class="flex items-center gap-5 mb-7 pl-4 lg:pl-0 pr-2 bg-white rounded-primary shadow-[0px_0px_4px_rgba(0,0,0,0.25)]">
                <span class="bg-primary lg:w-[240px] text-white text-center hidden lg:block lg:px-6 py-3 rounded-primary">
                    Full Name
                </span>
            ...
            <div class="flex items-center gap-5 mb-7 pl-4 lg:pl-0 pr-2 bg-white rounded-primary shadow-[0px_0px_4px_rgba(0,0,0,0.25)]">
                <span class="bg-primary lg:w-[240px] text-white text-center hidden lg:block lg:px-6 py-3 rounded-primary" title="Email">
                    Email
                </span>
            ...
            <div class="flex items-center gap-5 mb-7 pl-4 lg:pl-0 pr-2 bg-white rounded-primary shadow-[0px_0px_4px_rgba(0,0,0,0.25)]">
                <span class="bg-primary lg:w-[240px] text-white text-center hidden lg:block lg:px-6 py-3 rounded-primary" title="Password">
                    Password
                </span>
            ...
            <div class="flex items-center gap-5 mb-7 pr-2 bg-white rounded-primary shadow-[0px_0px_4px_rgba(0,0,0,0.25)]">
                <span class="cursor-pointer bg-primary lg:w-[240px] text-white text-center px-4 lg:px-6 py-3 rounded-primary" title="Upload Photo Profile"
