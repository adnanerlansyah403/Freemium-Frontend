                ...
                <div class="col col-12 lg:col-4 md:order-2 h-max py-5 px-4 rounded-primary bg-white dark:bg-slate-secondary dark:text-white shadow-[0px_0px_4px_rgba(0,0,0,0.25)] flex flex-col items-center">
                    ...
                    <div class="mt-12 flex flex-col items-center justify-center">
                        ...
                        <p class="flex items-center gap-2">
                            ...
                            <span class="bg-primary dark:bg-slate-third rounded-primary py-1 px-3 text-white" x-text="data_user.subscribe_status == 1 ? 'Member - '+data_user.payments[0].plan.name : 'Not a Member'">Member - Lifetime</span>
                        </p>
                    </div>
                </div>
