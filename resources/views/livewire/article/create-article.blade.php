        ...
        <div class="container mx-auto flex items-center">
            ...
            <div class="col col-12" x-data="article">
                ...
                <div class="flex flex-wrap lg:flex-nowrap">
                    ...
                    <div class="mb-5 col-12 lg:col lg:col-6" x-data="user">
                        ...
                        <select name="category_id" id=""
                            class="categories px-2 py-4 w-full shadow-[0px_0px_4px_rgba(0,0,0,0.25)] rounded-primary bg-white mt-4">
                ...
                <div class="mb-5">
                    ...
                    <input id="thumbnail" type="file" name="thumbnail" placeholder="Your thumbnail..." hidden
                        x-ref="file" @change="
                            if ($refs.file) {
                    ...
                    <span
                        ...
                        {{-- <span
                            class="removefile absolute w-max top-3 -right-full p-2 bg-primary text-white text-center font-semibold rounded-lg hover:text-opacity-80 transition duration-200 ease-in-out"
                            x-ref="removefile" @click="">
                        </span> --}}
                        ...
                        {{-- <li class="bg-white my-2 shadow-lg accordion" x-data="accordion(1)">
                            <h2 class="flex flex-row justify-between items-center font-semibold p-3 cursor-pointer">
                                ...
                                <div class="flex items-center gap-2">
                                    <span
                                        class="p-1 rounded-full text-gray-secondary hover:text-opacity-60 shadow-[0px_0px_4px_rgba(0,0,0,0.3)]">
                                        <i data-feather="trash-2" class="text-xs"></i>
                                    </span>
                                    <svg :class="handleRotate()" @click="handleClick()"
                            ...
                            <div x-ref="tab" :style="handleToggle()"
                                ...
                                <div class="mb-5">
                                    <label for="text" class="text-md">Thumbnail</label>
                                    <input type="file" name="thumbnail" placeholder="Your thumbnail..." hidden
                                        x-ref="file" @change="
                                            if ($refs.file) {
                                                $refs.iconimage.style.display = 'none';
                                                var reader = new FileReader();
                                    ...
                                    <span
                                        ...
                                        ">
                                        <img src="" x-ref="image" class="absolute w-full h-full object-cover rounded-lg"
                                            alt="">
