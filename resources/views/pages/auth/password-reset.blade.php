        ...
        <div class="container mx-auto flex items-start justify-center">
            ...
            <div class="col col-12 md:col-6 lg:col-6 py-6 px-4 border border-gray-third bg-white dark:bg-slate-secondary rounded-primary lg:flex flex-col items-center">
                    ...
                    <div class="w-full">
                        ...
                        <div class="flex items-center gap-4 pl-4 pr-3 py-4 w-full shadow-[0px_0px_4px_rgba(0,0,0,0.25)] bg-white hover:bg-white dark:bg-slate-secondary dark:shadow-none dark:border dark:border-white rounded-primary mt-4" x-bind:class="status_err.email ? 'shadow-none border border-[#b91c1c]' : ''">
