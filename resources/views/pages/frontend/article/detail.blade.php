...
<section class="py-[100px]" x-data="user">
    <div x-data="articles" x-init="checkSession()">
        ...
        <div class="container mx-auto">
            <figure class="mb-7">
                <img x-bind:src="content ? imgUrl + content.thumbnail : imgUrl + detailArticle.thumbnail" src="" class="w-full h-[250px] bg-gray-secondary" alt="">
            </figure>
            ...
            <div class="col md:mx-0 col-12 lg:col-8">
                <div class="flex flex-wrap gap-4 md:gap-0 justify-between">
                    <div class="flex gap-3">
                        <figure class="">
                            <img x-bind:src="imgUrl+detailArticle.author.photo" src="" class="w-[60px] h-[60px] bg-gray-secondary rounded-full border-none" alt="">
                        </figure>
                        <div class="">
                            ...
                            <div class="flex items-center gap-2" x-data="helpers">
                                <span class="flex items-center gap-1">
                                    ...
                                    <p x-text="convertDate(content ? content.created_at : detailArticle.created_at)"></p>
                                </span>
                                <span class="flex items-center gap-1">
                                    <i data-feather="eye" class="w-4 h-4"></i>
                                    <p>
                                        <span x-text="content ? content.total_views : detailArticle.total_views_sum"></span>
                                        View
                                    </p>
                                </span>
                            </div>
                ...
                <div>
                    <h2 class="text-md mt-5 mb-4" x-text="content ? content.title : detailArticle.title">Judul Artikel</h2>
                    <p x-text="content ? content.description : detailArticle.description">
                    </p>
                </div>
    
                <div class="flex content-center flex-wrap gap-3 mt-12">
                    <span x-text="console.log(detailArticle, content)"></span>
            ...
            <div class="col md:mx-0 col-12 lg:col-4">
                ...
                <div class="mt-6 px-5 py-6 bg-white shadow-[0px_0px_4px_rgba(0,0,0,0.3)] rounded-lg">
                    ...
                    <ul class="flex flex-col gap-4">
                        ...
                        <template x-if="back">
                            <li @click="content = null; back = false" class="p-3 rounded-primary shadow-[0px_0px_4px_#7C000B] cursor-pointer bg-primary text-white hover:skew-y-1 transition duration-200 ease-in-out text-center">
