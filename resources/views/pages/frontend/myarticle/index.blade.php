...
@section("content")
<section class="py-[100px]" x-data="myarticle">
    <div x-init="checkSession()"></div>
    <template x-if="isLogedIn">
        <div x-data="myarticle">
            <div x-init="fetchMyArticle()"></div>
            ...
            <div class="container mx-auto mt-10 w-full">
                ...
                <template x-for="data in myarticle">
                    <div class="flex items-center flex-wrap lg:flex-nowrap justify-center lg:justify-between gap-6 mb-10">
                        <div class="col col-8" style="margin: 0 !important;">
                            <div class="flex items-center gap-3">
                                <figure>
                                    <img x-bind:src="imgUrl+data.author.photo" src="" class="w-10 h-10 bg-gray-primary rounded-full" alt="">
                                </figure>
                                <div>
                                    <span class="font-bold text-base" x-text="data.author.name">Nama Author</span>
                            ...
                            <div class="flex items-center justify-between mt-6 mb-4">
                                <span class="text-md font-bold" x-text="data.title">Judul Artikel</span>
                                <i class="bg-primary px-4 py-2 rounded-primary text-white font-bold" x-text="data.type">Paid</i>
                            </div>
                            <p class="text-sm text-gray-secondary" x-text="data.description">
                        ...
                        <figure class="col col-3 hidden lg:flex items-center justify-center" style="margin: 0 !important;">
                            <img x-bind:src="imgUrl+data.thumbnail" src="" class="w-[150px] h-[150px] bg-gray-primary rounded-lg" alt="">
                        </figure>
